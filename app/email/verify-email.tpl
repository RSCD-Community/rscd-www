        ...
        <tr>
            <td style="border:2px solid #382418;background:#000000;padding:18px 22px;">
                ...
                <p style="margin:0 0 10px 0;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:19px;color:#ffffff;">
                    Your account has been created. To activate it you need to verify this email address &mdash; press the button below.
                </p>
                <!-- BUTTON -->
                <table cellpadding="0" cellspacing="0" border="0" style="margin:16px 0 8px 0;">
                <tr>
                    <td style="border:2px outset #f0f0f0;background:#d4d0c8;">
                        <a href="%%activation_url%%" target="_blank" style="display:block;padding:5px 18px;font-family:Arial,Helvetica,sans-serif;font-size:13px;font-weight:bold;color:#000000;text-decoration:none;">Verify email address</a>
                    </td>
                </tr>
                </table>
                <p style="margin:0 0 10px 0;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:17px;color:#b0a890;">
                    Or copy this link into your browser:<br />
                    <a href="%%activation_url%%" target="_blank" style="color:#90c040;text-decoration:none;">%%activation_url%%</a>
                </p>
