...
<!--
  ...
  links, Arial 13px white text. The warning paragraph wears the site's
  .alert-danger colours (#e03010 border, #ff6040 text). Tables and inline
  styles because mail clients ignore stylesheets; no images because mail
  clients block them by default and the mail should read fine without them.
-->
    ...
    <td align="center" style="padding:24px 10px;">
        ...
        <tr>
            <td style="border:2px solid #382418;background:#000000;padding:18px 22px;">
                ...
                <p style="margin:0 0 12px 0;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:19px;color:#ffffff;">
                    The sign-in password for your account has just been changed.
                </p>
                <!-- WARNING (the site's .alert-danger) -->
                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0 0 12px 0;">
                <tr>
                    <td style="border:2px solid #e03010;background:#000000;padding:6px 10px;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:19px;color:#ff6040;">
                        If this was not you, write to <a href="mailto:%%app.supportEmailAddress%%" style="color:#ff6040;text-decoration:underline;">%%app.supportEmailAddress%%</a> immediately so your account can be protected.
                    </td>
                </tr>
                </table>
                <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:19px;color:#ffffff;">
